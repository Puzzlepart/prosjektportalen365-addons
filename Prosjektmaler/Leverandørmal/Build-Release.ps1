<#
.SYNOPSIS
Builds a release package for Prosjektportalen 365 leverandørmal

.DESCRIPTION
Builds a release package for Prosjektportalen 365 leverandørmal. The release package contains all files needed to install Prosjektportalen 365 leverandørmal in a PP365 installation.
#>
...
$RELEASE_NAME = "pp365-leverandørmal-1.0.0.$($GIT_HASH)"
...
Convert-PnPFolderToSiteTemplate -Out "$RELEASE_PATH_TEMPLATES/leverandørmal.pnp" -Folder $PNP_TEMPLATES_BASEPATH -Force
