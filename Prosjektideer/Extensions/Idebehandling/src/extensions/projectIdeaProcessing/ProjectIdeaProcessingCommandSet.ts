...
const LOG_SOURCE: string = "ProjectIdeaProcessCommandSet";
...
export default class ProjectIdeaProcessCommandSet extends BaseListViewCommandSet<any> {
  private userAuthorized: boolean;

  @override
  public async onInit(): Promise<void> {
    Log.info(LOG_SOURCE, "Initialized ProjectIdeaProcessCommandSet");
